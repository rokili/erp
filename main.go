...
CREATE TABLE IF NOT EXISTS finance_voucher_entry (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS inventory_fifo_layer (
    id SERIAL PRIMARY KEY,
    product_id INTEGER NOT NULL REFERENCES product(id),
    quantity NUMERIC(18,3) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_voucher_entry_account ON finance_voucher_entry(account_code);
CREATE INDEX IF NOT EXISTS idx_voucher_entry_voucher ON finance_voucher_entry(voucher_id);
...
CREATE INDEX IF NOT EXISTS idx_inventory_transaction_product ON inventory_transaction(product_id);
CREATE INDEX IF NOT EXISTS idx_inventory_transaction_date ON inventory_transaction(transaction_date);
CREATE INDEX IF NOT EXISTS idx_inventory_fifo_layer_product ON inventory_fifo_layer(product_id);
